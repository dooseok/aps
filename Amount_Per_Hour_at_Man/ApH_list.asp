...
'1/9
'----------------------------------------------------------------------------------
strSelectName		= "파트넘버,생산월,생산라인,생산수량,소요시간(분),시간당생산량"
strWidth			= "90,90,90,90,90,90"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/Amount_Per_Hour_at_Man/aph_list.asp"
URL_View			= "/Amount_Per_Hour_at_Man/aph_list.asp"
URL_Action			= "/Amount_Per_Hour_at_Man/aph_list.asp"
URL_Reg				= "/Amount_Per_Hour_at_Man/aph_list.asp"

strTable			= "vwAmount_Per_Hour_at_Man"
strPK				= "BOM_Sub_BS_D_No"
strSelect			= "BOM_Sub_BS_D_No,PR_Work_Month,PR_Line,sumPR_Amount,sumPeriod,Amount_Per_Hour"
...
if Len(Request("s_PR_Work_Date")) = "22" Then
	If Trim(strWhere) <> "" Then
		strWhere = strWhere & " and "
	End If
	strWhere = strWhere & " convert(int,PR_Work_Month) between "&Left(replace(Request("s_PR_Work_Date"),"-",""),6)&" and "&left(Right(replace(Request("s_PR_Work_Date"),"-",""),8),6)
	'strWhere = strWhere & " convert(int,PR_Work_Month) > 0 "
	'response.write strWhere
end if

if S_Order_By_1 & S_Order_By_2 = "" then
	S_Order_By_1 	= "BOM_Sub_BS_D_No"
	S_Order_By_2 	= "asc"
end if

if S_Order_By_3 & S_Order_By_4 = "" then
	S_Order_By_3 	= "PR_Work_Month"
	S_Order_By_4 	= "asc"
end if

strID				= "BOM_Sub_BS_D_No"
strID_Pos			= "0"
'----------------------------------------------------------------------------------
...
strColumn		= "s_bom_sub_bs_d_no,s_PR_Work_Date"
strName			= "파트넘버,생산기간(월단위)"
strType			= "dn2,dt2"
'----------------------------------------------------------------------------------
