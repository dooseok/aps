...
arrPWS_Rest_Data(0,3) = "1000"
arrPWS_Rest_Data(0,4) = "1010"
arrPWS_Rest_Data(0,5) = "REST"
arrPWS_Rest_Data(0,6) = "0"
arrPWS_Rest_Data(0,7) = "1000"
arrPWS_Rest_Data(0,8) = "1010"
arrPWS_Rest_Data(1,0) = "무작업"	'2nd 휴식
arrPWS_Rest_Data(1,1) = "0"
arrPWS_Rest_Data(1,2) = "0"
arrPWS_Rest_Data(1,3) = "1200"
arrPWS_Rest_Data(1,4) = "1300"
arrPWS_Rest_Data(1,5) = "REST"
arrPWS_Rest_Data(1,6) = "0"
arrPWS_Rest_Data(1,7) = "1200"
arrPWS_Rest_Data(1,8) = "1300"
arrPWS_Rest_Data(2,0) = "무작업"	'3rd 휴식
arrPWS_Rest_Data(2,1) = "0"
arrPWS_Rest_Data(2,2) = "0"
arrPWS_Rest_Data(2,3) = "1500"
arrPWS_Rest_Data(2,4) = "1510"
arrPWS_Rest_Data(2,5) = "REST"
arrPWS_Rest_Data(2,6) = "0"
arrPWS_Rest_Data(2,7) = "1500"
arrPWS_Rest_Data(2,8) = "1510"
arrPWS_Rest_Data(3,0) = "무작업"	'4th 휴식
arrPWS_Rest_Data(3,1) = "0"
arrPWS_Rest_Data(3,2) = "0"
arrPWS_Rest_Data(3,3) = "1700"
arrPWS_Rest_Data(3,4) = "1730"
arrPWS_Rest_Data(3,5) = "REST"
arrPWS_Rest_Data(3,6) = "0"
arrPWS_Rest_Data(3,7) = "1700"
arrPWS_Rest_Data(3,8) = "1730"
...
redim arrRemain(ubound(arrPWS_Opt_Data))
redim arrRndRate(ubound(arrPWS_Opt_Data))
CurrentRecord = 0
for CNT1 = 0 to ubound(arrPWS_Opt_Data)
	...
	if isnumeric(arrPWS_Opt_Data(CNT1,6)) then
	else
		arrPWS_Opt_Data(CNT1,6) = 0
	end if
	
	if arrPWS_Opt_Data(CNT1,0) = "" then
	elseif arrPWS_Opt_Data(CNT1,0) = "none" then
	...
	elseif arrPWS_Opt_Data(CNT1,0) = "무작업" then
		...
		if arrPWS_Opt_Data(CNT1,5) = "raw" then
			...
			response.write nRemain & "----------"
			arrRemain(CNT1) 	= nRemain
			arrRndRate(CNT1)	= rndRate
		end if
	end if
next
