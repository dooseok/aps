...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "번호,파트넘버,구분,스펙,날짜,거래처,입고,출고,수정,직전재고,현재재고,비고,등록일,등록자"

strWidth			= ""
strWidth			= strWidth		& "40,100,100,150,70,120,60,60,60,70,70,120,140,70"
'----------------------------------------------------------------------------------
...
URL_This			= "/material/mt_list.asp"
URL_View			= "/material/mt_edit_form.asp"
URL_Action			= "/material/mt_list_action.asp"
URL_Reg				= "/material/mt_reg_action.asp"

strTable			= "vwMT_List"
strPK				= "mt_code"
strSelect			= ""
strSelect			= strSelect		& "MT_Code,Material_M_P_No,M_Desc,M_Spec,MT_Date,Partner_P_Name,MT_Qty_In,MT_Qty_Out,MT_Qty_Update,MT_Qty_Last,MT_Qty_Now,MT_Desc,MT_Reg_Date,MT_Reg_ID"
...
if Request("s_Total") <> "" then
	...
	End If
	strWhere = strWhere & "(Material_M_P_No like ''%"&Request("s_Total")&"%'' or M_Desc like ''%"&Request("s_Total")&"%'' or M_Spec like ''%"&Request("s_Total")&"%'' or M_Spec like ''%"&Request("s_Total")&"%'' or Partner_P_Name like ''%"&Request("s_Total")&"%'')"
end If
...
'4/9
'----------------------------------------------------------------------------------
strColumn		= "s_Total,s_Material_M_P_No,s_Partner_P_Name,s_MT_Out_byWho,s_MT_Date,s_edit_mode_yn"
strName			= "통합검색,파트넘버,거래처,요청자,날짜,수정모드"
strType			= "txt,txt,ptn,txt,dt2,chk"
'----------------------------------------------------------------------------------
