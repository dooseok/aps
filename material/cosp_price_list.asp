...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "번호,파트넘버,구분,사급가,적용일"

strWidth			= ""
strWidth			= strWidth		& "50,110,200,90,90"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/material/cosp_price_list.asp"
URL_View			= "/material/cosp_price_list.asp"
URL_Action			= "/material/cosp_price_list.asp"
URL_Reg				= "/material/cosp_price_list.asp"

strTable			= "tbCOSP_Price"
strPK				= "cp_code"
strSelect			= ""
strSelect			= strSelect		& "CP_Code,Material_M_P_No,CP_Type,CP_Price,CP_StartDate"
...
<tr>
	<td align=center>
		...
		<form name="frmFileUpload" action="cosp_price_xls_upload_action.asp" method="post" enctype="MULTIPART/FORM-DATA">
		<tr>
<%
if Request("s_edit_mode_yn") <> "" then
%>
