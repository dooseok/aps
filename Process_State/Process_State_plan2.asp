...
<form name="frmPlan_State_list" action="Process_State_plan2_action.asp" method="post">
<input type="hidden" name="s_Work_Date"			value="<%=request("s_Work_Date")%>">
<input type="hidden" name="s_Line"				value="<%=request("s_Line")%>">
<tr height=400px>
	<td id="idPlan_State" align=center>
		<table width=340px border=1 height=400px>
		<tr>
			<td width=70px align=center>작업<br>모델</td>
			<td width=100px><textarea name="lstBOM_Sub_BS_D_No" cols=15 style="height:100%;"></textarea></td>
			<td width=70px align=center>목표<br>수량</td>
...
<form name="frmPlan_State" action="Process_State_plan2_action.asp" method="post">
<input type="hidden" name="s_Work_Date"			value="<%=request("s_Work_Date")%>">
<input type="hidden" name="s_Line"				value="<%=request("s_Line")%>">
<tr>
...
%>
		<tr style="height:10px">
			...
			<td><input type='text' name='PSP_ST'			style='width:98%'	readonly	value="<%=arrOptPSP_ST(CNT1)%>"></td>
