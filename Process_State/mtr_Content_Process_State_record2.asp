...
'SQL = "insert into tbTest_SetInterval (ts_Work,ts_Desc,ts_Now,ts_Diff) values ('ProcessState','"&s_Line&"',getdate(),0)"
...
'	response.write arrPWS_Raw_Data(CNT1,0)&"/<br>"
'	response.write arrPWS_Raw_Data(CNT1,1)&"/<br>"
'	response.write arrPWS_Raw_Data(CNT1,2)&"/<br>"
'	response.write arrPWS_Raw_Data(CNT1,4)&"/<br>"
'	response.write arrPWS_Raw_Data(CNT1,3)&"/<br><br>"
'next
'response.write "1"
'휴식 정보의 배열화
...
for CNT1=1 to ubound(arrPWS_Plan_Data)
	...
	'response.write int(left(arrPWS_Plan_Data(CNT1,7),2)*60+right(arrPWS_Plan_Data(CNT1,7),2)) - int(left(arrPWS_Plan_Data(CNT1-1,8),2)*60+right(arrPWS_Plan_Data(CNT1-1,8),2)) &"<br>"
