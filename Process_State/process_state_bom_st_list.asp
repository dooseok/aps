...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "번호,모델명,수삽ST,조립ST,IMD점수,SMD점수,수삽점수,조립점수"
strWidth			= ""
strWidth			= strWidth		& "60,90,60,60,60,60,60,60"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/process_state/process_state_bom_st_list.asp"
URL_View			= "/process_state/process_state_bom_st_list.asp"
URL_Action			= "/process_state/process_state_bom_st_list_action.asp"
URL_Reg				= "/process_state/process_state_bom_st_list.asp"

strTable			= "vwProcess_State_BOM_ST_List"
strPK				= "BS_Code"
strSelect			= "BS_Code,BS_D_No,BS_ST,BS_ST_ASM,cntIMD,cntSMD,cntMAN,cntASM"
...
'3/9
'----------------------------------------------------------------------------------
if Request("s_b_d_no") <> "" then
	If Trim(strWhere) <> "" Then
		strWhere = strWhere & " and "
	End If
	strWhere = strWhere & "bs_d_no like ''"&Request("s_b_d_no")&"%''"
end If

if S_Order_By_1 & S_Order_By_2 = "" then
	S_Order_By_1 	= "bs_code"
	S_Order_By_2 	= "asc"
end if
...
'----------------------------------------------------------------------------------
call BOM_Guide()
strColumn		= "s_b_d_no,s_edit_mode_yn"
strName			= "파트넘버,수정모드"
strType			= "dn1,chk"
'----------------------------------------------------------------------------------
