...
%>
<iframe src="mtr_Content_dk_plan.asp?s_Work_Date=<%=s_Work_Date%>" width=1000px height=50px frameborder=0></iframe>
<%
else
%>
<iframe src="mtr_Content_dk_plan.asp?s_Work_Date=<%=s_Work_Date%>" width=0px height=0px frameborder=0></iframe>
<%
end if
%>
