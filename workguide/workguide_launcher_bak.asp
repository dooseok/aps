...
function update_ifrmLauncher()
{
	...
	ifrmLauncher_mc_checker.location.href='workguide_launcher_ifrm_MC_checker.asp?s_PRD_Line=<%=s_PRD_Line%>';
...
<tr bgcolor=white>
	<td bgcolor=white>
		<table width=100px cellpadding=0 cellspacing=0 border=0 style="border-left:solid 1px #cccccc;border-right:solid 1px #cccccc">
		<tr height=25px>
...
%>
<iframe frameborder=1 width=1000px height=50px name="ifrmCustomModel" src="about:blank"></iframe>
<iframe frameborder=1 width=1000px height=50px name="ifrmLauncher_filelist2DB" src="about:blank"></iframe>
<iframe frameborder=1 width=1000px height=50px name="ifrmLauncher_reloader" src="about:blank"></iframe>
<iframe frameborder=1 width=1000px height=50px name="ifrmLauncher_mc_checker" src="about:blank"></iframe>
