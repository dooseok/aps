...
if txtBS_D_No <> "" then
	SQL = "select distinct BS_D_No from tbBOM_Sub where BS_D_No like '%"&txtBS_D_No&"%' order by BS_D_No"
else
	SQL = "select distinct BS_D_No from tbBOM_Sub order by BS_D_No"
end if
...
<tr>
	<td>
		<select name="sltBS_D_No" size=17 onDblClick="javascript:parent.OnDoubleClickBOMSub(this.value)" style="width:100%;height:261px">
<%
