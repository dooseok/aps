...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "작업일,라인,직접원,간접원,시작,종료,총시간,무작업,생산량,직접공수,간접공수,무작업공수,실동공수,재작업공수,순작업공수,회수공수,능률,회수율,실동율,가동율"

strWidth			= ""
strWidth			= strWidth		& "80,40,50,50,50,50,50,50,50,60,60,70,70,70,70,60,50,50,50,50"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/process_report/pr_list.asp"
...
strPK				= "PR_Code"
strSelect			= ""
strSelect			= strSelect		& "PR_Work_Date,"
strSelect			= strSelect		& "PR_Line,"
strSelect			= strSelect		& "PR_Worker,"
strSelect			= strSelect		& "PR_Supporter,"
strSelect			= strSelect		& "PR_Start_Time,"
strSelect			= strSelect		& "PR_End_Time,"
strSelect			= strSelect		& "PR_Diff_Time,"
strSelect			= strSelect		& "PR_Loss_Ctrl,"
strSelect			= strSelect		& "PR_Amount,"
strSelect			= strSelect		& "JikJup_GongSu,"
strSelect			= strSelect		& "Ganjup_GongSu,"
strSelect			= strSelect		& "MuJakUp_GongSu,"
strSelect			= strSelect		& "SilDong_GongSu,"
strSelect			= strSelect		& "JeJakUp_GongSu,"
strSelect			= strSelect		& "SunJakUp_GongSu,"
strSelect			= strSelect		& "HoeSu_GongSu,"
strSelect			= strSelect		& "Neung_Yul,"
strSelect			= strSelect		& "HoeSu_Yul,"
strSelect			= strSelect		& "SilDong_Yul,"
strSelect			= strSelect		& "GaDong_Yul"
