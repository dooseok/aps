...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "작업일,라인,총인원,총시간,무작업,생산량,능률,회수율,실동율,가동율"

strWidth			= ""
strWidth			= strWidth		& "80,40,60,60,60,60,60,60,60,50"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/process_report/pr_summary_list.asp"
...
strSelect			= strSelect		& "PR_Total_Worker,"
