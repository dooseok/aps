...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/notice/n_list.asp"
URL_View			= "/notice/n_edit_form.asp"
URL_Action			= "/notice/n_list_action.asp"
URL_Reg				= "/notice/n_reg_action.asp"

strTable			= "vwN_List"
strPK				= "N_Code"
strSelect			= ""
strSelect			= strSelect		&"N_Code,Member_M_Part,Member_M_Name,N_Title,N_Reg_Date,N_Edit_Date"
...
'3/9
'----------------------------------------------------------------------------------
if Request("s_n_title") <> "" then
	If Trim(strWhere) <> "" Then
		strWhere = strWhere & " and "
	End If
	strWhere = strWhere & "n_title like ''%"&Request("s_n_title")&"%''"
end If
...
'4/9
'----------------------------------------------------------------------------------	
strColumn		= "s_member_m_part,s_member_m_name,s_n_title"
strName			= "부서,등록자,제목"
...
%>
			<td width=5px></td>
			<td width=77px>
				<%=Make_BTN("신규등록","javascript:location.href='n_reg_form.asp'","")%>
			</td>
			<td width=5px></td>
