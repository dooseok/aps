...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "번호,포장일,생산라인,파트넘버,수량"
strWidth			= ""
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/pws_raw_data/prd_list_box.asp"
...
strTable			= "vwPRD_list_Box"
strPK				= "minPRD_Code"
strSelect			= ""
strSelect			= strSelect		& "minPRD_Code, PRD_Box_Date, PRD_Line, PRD_PartNo, cntPRD_Code"
...
dim s_PRD_Box_Date
s_PRD_Box_Date = Request("s_PRD_Box_Date")
if Len(s_PRD_Box_Date) <> "22"  then
	s_PRD_Box_Date = date()&", "&date()
end if
...
if Len(s_PRD_Box_Date) = "22" Then
	If Trim(strWhere) <> "" Then
		strWhere = strWhere & " and "
	End If
	strWhere = strWhere & "PRD_Box_Date between ''"&Left(s_PRD_Box_Date,10)&"'' and ''"&Right(s_PRD_Box_Date,10)&"''"
end If
...
strColumn		= "s_PRD_PartNo,s_PRD_Box_Date"
strName			= "파트넘버,포장일"
strType			= "dn2,dt2"
'----------------------------------------------------------------------------------
...
<Script language="javascript">
	if(frmSearch_Bar.s_PRD_Box_Date[0].value == "" || frmSearch_Bar.s_PRD_Box_Date[1].value == "")
	{
		frmSearch_Bar.s_PRD_Box_Date[0].value="<%=date()%>";
		frmSearch_Bar.s_PRD_Box_Date[1].value="<%=date()%>";
	}
</script>
