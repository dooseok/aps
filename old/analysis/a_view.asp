...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "번호,파트넘버,지역,타입,통화,판가,등록일,적용일"

strWidth			= ""
strWidth			= strWidth		& "60,100,60,60,60,80,90,90"
'----------------------------------------------------------------------------------
...
strPK				= "bp_code"
strSelect			= ""
strSelect			= strSelect		& "BP_Code,BOM_Sub_BS_D_No,BP_Location,BP_Type,BP_Currency,BP_Price,BP_Reg_Date,BP_Apply_Date"
...
strDown				= ",,,,,,,"
strAlign			= ""
strAlign			= strAlign		& "Center,Center,Center,Center,Center,right,Center,Center"
'----------------------------------------------------------------------------------
...
%>
			<td width=5px></td>
<%
if instr(admin_b_price_list,"-"&Request.Cookies("ADMIN")("M_ID")&"-") > 0 then
%>
			<td width=120px>
