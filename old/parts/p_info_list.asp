...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "체크,번호,파트넘버,공정,파트이름,스펙(요약),스펙,메이커,현재재고"

strWidth			= ""
strWidth			= strWidth		& "30,40,100,60,120,160,200,100,65,50"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/parts/p_info_list.asp"
URL_View			= "/parts/p_info_edit_form.asp"
URL_Action			= "/parts/p_info_list_action.asp"
URL_Reg				= "/parts/p_info_reg_action.asp"

strTable			= "vwP_List"
strPK				= "p_code"
strSelect			= ""
strSelect			= strSelect		& "P_Code,P_P_No,P_Work_Type,P_Desc,P_Spec_Short,P_Spec,P_Maker,P_Qty"
...
if Request("s_edit_mode_yn") = "" then
	...
	strEdit	= ",mem,"&BasicDataPartsType&",mem,mem,mem,mem,mem,"
	
end if
strPopup			= ",,,,,,,,,,,,,,,"
strDown				= ",,,,,,,,,,,,,,,"
strAlign			= ""
strAlign			= strAlign		& "Center,Center,Center,Center,Center,Center,Center,right,"
strAlign			= strAlign		& "Center"
'----------------------------------------------------------------------------------
...
'4/9
'----------------------------------------------------------------------------------	
strColumn		= "s_bom_sub_bs_d_no,s_p_p_no,s_p_desc,s_p_spec,s_p_maker|/|s_P_Qty_up,s_P_Qty_down"
strName			= "모델파트넘버,부품파트넘버,파트이름,스펙,메이커|/|재고량(이상),재고량(이하)"
strType			= "txt,txt,txt,txt,txt|/|num,num"
'----------------------------------------------------------------------------------
...
'6/9
'----------------------------------------------------------------------------------	
	strReg	= ",mem,"&BasicDataPartsType&",mem,mem,mem,mem,mem,"
'----------------------------------------------------------------------------------	
