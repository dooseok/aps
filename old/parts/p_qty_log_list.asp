...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "번호,파트넘버,재고,수정일"

strWidth			= ""
strWidth			= strWidth		& "70,120,100,180"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/parts/P_Qty_log_list.asp"
URL_View			= "/parts/P_Qty_log_edit_form.asp"
URL_Action			= "/parts/P_Qty_log_list_action.asp"
URL_Reg				= "/parts/P_Qty_log_reg_action.asp"

strTable			= "tbParts_Qty_Log"
strPK				= "pql_code"
strSelect			= ""
strSelect			= strSelect		& "PQL_Code,Parts_P_P_No,PQL_Qty,PQL_Update_Date"
...
if Request("s_parts_P_P_No") <> "" then
	...
	End If
	strWhere = strWhere & "parts_P_P_No = ''"&Request("s_parts_P_P_No")&"''"
end If

if S_Order_By_1 & S_Order_By_2 = "" then
	S_Order_By_1 	= "pql_code"
	S_Order_By_2 	= "desc"
end if
