...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "번호,파트넘버,SMD재고,MAN재고,ASM재고,수정일"

strWidth			= ""
strWidth			= strWidth		& "70,120,80,80,80,180"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/bom/b_sub_qty_log_list.asp"
URL_View			= "/bom/b_sub_qty_log_edit_form.asp"
URL_Action			= "/bom/b_sub_qty_log_list_action.asp"
URL_Reg				= "/bom/b_sub_qty_log_reg_action.asp"

strTable			= "tbBom_Sub_Qty_Log"
strPK				= "bsql_code"
strSelect			= ""
strSelect			= strSelect		& "BSQL_Code,BOM_Sub_BS_D_No,BSQL_SMD_Qty,BSQL_MAN_Qty,BSQL_ASM_Qty,BSQL_Update_Date"
