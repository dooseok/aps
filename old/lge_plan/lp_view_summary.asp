...
<form name="frmDate_Search" action="lp_view_summary.asp" method="post">
<tr height=25px>
	<td bgcolor=white>
...
<br>
<table width="<%=200+(30*(s_Diff_LPD_Input_Date+1))%>"px cellpadding=0 cellspacing=0 border=0 bgcolor="#999999" class="LGE_Plan">
<tr bgcolor=dimgray>
...
SQL = SQL & "order by BOM_Sub_BS_D_No asc, LP_Tool_Type asc "&vbcrlf
for CNT1 = 0 to s_Diff_LPD_Input_Date
