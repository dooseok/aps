...
<form name="frmDate_Search" action="lp_view_summary_int.asp" method="post">
<tr height=25px>
	<td bgcolor=white>
...
<br>
<table width="<%=420+(40*(s_Diff_LPD_Input_Date+1))%>"px cellpadding=0 cellspacing=0 border=0 bgcolor="#999999" class="LGE_Plan">
<tr bgcolor=dimgray>
...
next
%>
	<td width=40px align=center style="color:white"><b>QTY</b>&nbsp;</td>
	<td width=80px align=center style="color:white"><b>POINT</b></td>
	<td width=100px align=center style="color:white"><b>SUM</b></td>
</tr>
<%
SQL = 		"select "&vbcrlf
...
<%
			...
			next
%>
	<td width=40px align=center style="color:darkblue"><%=Sum_QTY_BOM_Sub_BS_D_No%></td>
	<td width=80px>&nbsp;</td>
	<td width=100px align=center style="color:darkblue"><%=customformatcomma(Sum_CAL_BOM_Sub_BS_D_No)%></td>
</tr>
...
<%	
		SQL = "select count(BQ_Code) from tbBOM_Qty where BOM_Sub_BS_D_No = '"&arrBOM_Sub_BS_D_No(CNT1)&"' and Parts_P_P_No in (select P_P_No from tbParts where P_Work_Type in ('IMD','I/M'))"
		RS2.Open SQL,sys_DBCon
		Point_BOM_Sub_BS_D_No = RS2(0)
		RS2.Close
		...
		for CNT2 = 0 to s_Diff_LPD_Input_Date
			...
			if isnumeric(strQty) then
				...
				arrDateQty(CNT2) = arrDateQty(CNT2) + strQty * Point_BOM_Sub_BS_D_No
			end if
%>
...
<%
		...
		CAL_BOM_Sub_BS_D_No = QTY_BOM_Sub_BS_D_No * Point_BOM_Sub_BS_D_No
		
		Sum_QTY_BOM_Sub_BS_D_No		= Sum_QTY_BOM_Sub_BS_D_No	+ QTY_BOM_Sub_BS_D_No
		Sum_CAL_BOM_Sub_BS_D_No		= Sum_CAL_BOM_Sub_BS_D_No	+ CAL_BOM_Sub_BS_D_No * Point_BOM_Sub_BS_D_No
%>
	<td width=40px bgcolor="<%=strBG_Color%>" align=center><%=QTY_BOM_Sub_BS_D_No%></td>
	<td width=80px bgcolor="<%=strBG_Color%>" align=center><%=customformatcomma(Point_BOM_Sub_BS_D_No)%></td>
	<td width=100px bgcolor="<%=strBG_Color%>" align=center><%=customformatcomma(CAL_BOM_Sub_BS_D_No)%></td>
</tr>
<%
...
<%
			next
%>
	<td width=40px align=center style="color:darkblue"><%=Total_QTY_BOM_Sub_BS_D_No%></td>
	<td width=80px>&nbsp;</td>
	<td width=100px align=center style="color:darkblue"><%=customformatcomma(Total_CAL_BOM_Sub_BS_D_No)%></td>
</tr>
<tr height=15px><td colspan=100 bgcolor="#ffffff"><img src="/img/blank.gif" width=1px height=15px></td></tr>
</table>
