...
<%	
		SQL = "select count(BQ_Code) from tbBOM_Qty where BOM_Sub_BS_D_No = '"&arrBOM_Sub_BS_D_No(CNT1)&"' and Parts_P_P_No in (select P_P_No from tbParts where P_Work_Type = 'SMD')"
		RS2.Open SQL,sys_DBCon
