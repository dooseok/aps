...
if instr(admin_lm_list,"-"&Request("Admin")("M_ID")&"-") > 0 then
	strSelectName		= strSelectName & "번호,업체구분,모델명,파트넘버1,파트넘버2,파트넘버3,파트넘버4,삭제"
else
	strSelectName		= strSelectName & "번호,업체구분,모델명,파트넘버1,파트넘버2,파트넘버3,파트넘버4"
end if
strWidth			= ""
