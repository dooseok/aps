...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "제품코드,세번코드,품명+규격,규격,물량단위,소요량산정방식,규격2"

strWidth			= ""
strWidth			= strWidth		& "100,100,300,60,60,60,60,60"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/bom/b_sub_priced_list.asp"
URL_View			= "/bom/b_sub_priced_list.asp"
URL_Action			= "/bom/b_sub_priced_list.asp"
URL_Reg				= "/bom/b_sub_priced_list.asp"

strTable			= "vwB_Sub_Priced"
strPK				= "bsp_d_no"
strSelect			= ""
strSelect			= strSelect		& "BSP_D_No,BSP_TaxCode,BSP_Desc,Spec,Unit,CalcMethod,Unit2"
...
strDown				= ",,,,,,,,"
strAlign			= ""
strAlign			= strAlign		& "Center,Center,Center,Center,Center,Center,Center,Center"
'----------------------------------------------------------------------------------

'3/9
'----------------------------------------------------------------------------------
if Request("s_bsp_d_no") <> "" then
	If Trim(strWhere) <> "" Then
		strWhere = strWhere & " and "
	End If
	strWhere = strWhere & "bsp_d_no like ''%"&Request("s_bsp_d_no")&"%''"
end If

if S_Order_By_1 & S_Order_By_2 = "" then
	S_Order_By_1 	= "bsp_d_no"
	S_Order_By_2 	= "desc"
end if
