...
'----------------------------------------------------------------------------------
strSelectName		= ""
strSelectName		= strSelectName & "번호,파트넘버,구분,적용일,회신일,회신요구일,내용(요약),File1,File2,File3,작업_삭제"
strWidth			= ""
strWidth			= strWidth		& "100,100,100,100,100,100,200,100,100,100,100"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/bom/BU_list.asp"
URL_View			= "/bom/BU_edit_form.asp"
URL_Action			= "/bom/BU_list_action.asp"
URL_Reg				= "/bom/BU_reg_action.asp"

strTable			= "vwBU_List"
strPK				= "BU_Code"
strSelect			= ""
strSelect			= strSelect		&"BU_Code,BOM_B_D_No,BU_Type,BU_Apply_Date,BU_Reply_Date,BU_Request_Reply_Date,BU_Content,BU_File_1,BU_File_2,BU_File_3"
...
strDown				= ",,,,,,,"&DefaultPath_BOM_Update&","&DefaultPath_BOM_Update&","&DefaultPath_BOM_Update&","
strAlign			= "Center,Center,Center,Center,Center,Center,left,Center,Center,Center,Center,Center"
'----------------------------------------------------------------------------------
...
%>
			<td width=77px><%=Make_BTN("신규등록","javascript:location.href='BU_reg_form.asp'","")%></td>
<%
'else
%><!--
...
%>
			<td width=5px></td>
			<td width=77px><%=Make_BTN("기간별인쇄","javascript:printPeriod()","")%></td>
		</tr>
		</table>
	</td>
</tr>
