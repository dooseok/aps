...
if instr(admin_b_list,"-"&gM_ID&"-") > 0 then
	strSelectName		= "번호,BOM 품명,정규화 품명,삭제"
else
	strSelectName		= "번호,BOM 품명,정규화 품명,삭제"
end if
strWidth			= "50,400,400,70"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/bom/parts_desc_list.asp"
URL_View			= "/bom/parts_desc_list_del_action.asp"
URL_Action			= "/bom/parts_desc_list_action.asp"
URL_Reg				= "/bom/parts_desc_list_reg_action.asp"

strTable			= "tblBOM_Mask_Desc_Detail"
strPK				= "BMDD_Code"
strSelect			= "BMDD_Code,BMDD_Desc_BOM,BOM_Mask_Desc_BMD_Desc"
...
if Request("s_BOM_Mask_Desc_BMD_Desc") <> "" Then
	If Trim(strWhere) <> "" Then
		strWhere = strWhere & " and "
	End If
	strWhere = strWhere & "BOM_Mask_Desc_BMD_Desc like ''%"&Request("s_BOM_Mask_Desc_BMD_Desc")&"%''"
end if


if Request("s_BMDD_Desc_BOM") <> "" Then
	If Trim(strWhere) <> "" Then
		strWhere = strWhere & " and "
	End If
	strWhere = strWhere & "BMDD_Desc_BOM like ''%"&Request("s_BMDD_Desc_BOM")&"%''"
end if


if S_Order_By_1 & S_Order_By_2 = "" then
	S_Order_By_1 	= "BMDD_Code"
	S_Order_By_2 	= "desc"
end if
...
strColumn		= "s_BMDD_Desc_BOM,s_BOM_Mask_Desc_BMD_Desc,s_edit_mode_yn"
strName			= "BOM품명,정규화품명,수정모드"
strType			= "txt,txt,chk"
'----------------------------------------------------------------------------------
