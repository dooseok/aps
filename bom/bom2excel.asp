...
'1/9
'----------------------------------------------------------------------------------
strSelectName		= "NO,AssyPNO,PartPNO,Qty,Remark,Desk,Spec,Maker,Order,Checksum"
strWidth			= "100,100,100,100,100,100,100,100,100,100"
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/bom/bom2excel.asp"
URL_View			= "/bom/bom2excel.asp"
URL_Action			= "/bom/bom2excel.asp"
URL_Reg				= "/bom/bom2excel.asp"

strTable			= "vwBOM2Excel"
strPK				= "BQ_Code"
strSelect			= "BQ_Code,BOM_Sub_BS_D_No,Parts_P_P_No,BQ_Qty,BQ_Remark,BQ_P_Desc,BQ_P_Spec,BQ_P_Maker,BQ_Order,BQ_Checksum"
...
<form name="frmList2Excel" action="/function/inc_List2Excel_bom.asp" method="post" target="ifrmXLSDown">
