...
if instr("-IMD-SMD-",S_PR_Process) > 0 then
	strSelectName		= strSelectName & "번호,작업날짜,제번,라인,직접원,간접원,작업구분,파트넘버,계획,양품,불량,<계획,계획>,<실적,실적>,LOSS,휴식,비고,소요,점수,점수계,삭제"
elseif instr("-MAN-",S_PR_Process) > 0 then
	strSelectName		= strSelectName & "번호,작업날짜,제번,라인,직접원,간접원,작업구분,파트넘버,계획,양품,불량,<계획,계획>,<실적,실적>,LOSS,휴식,비고,소요,S/T,삭제"
elseif instr("-ASM-DLV-",S_PR_Process) > 0 then
	strSelectName		= strSelectName & "번호,작업날짜,제번,라인,직접원,간접원,작업구분,파트넘버,계획,양품,불량,<계획,계획>,<실적,실적>,LOSS,휴식,비고,소요,삭제"
end if

strWidth			= ""

if instr("-IMD-SMD-",S_PR_Process) > 0 then
	strWidth			= strWidth		& "40,70,80,50,50,50,70,90,40,40,40,50,50,50,50,50,50,200,50,50,50,50"
elseif instr("-MAN-",S_PR_Process) > 0 then
	strWidth			= strWidth		& "40,70,80,50,50,50,70,90,40,40,40,50,50,50,50,50,50,200,50,50,50"
elseif instr("-ASM-DLV-",S_PR_Process) > 0 then
	strWidth			= strWidth		& "40,70,80,50,50,50,70,90,40,40,40,50,50,50,50,50,50,200,50,50"
end if
'----------------------------------------------------------------------------------
...
strSelect			= ""
if instr("-IMD-SMD-",S_PR_Process) > 0 then
	strSelect			= strSelect		& "PR_Code,PR_Work_Date,PR_Work_Order,PR_Line,PR_Worker_CNT,PR_Supporter_CNT,PR_WorkType,BOM_Sub_BS_D_No,PR_Plan_Amount,PR_Amount,PR_Amount_NG,PR_Plan_Start_Time,PR_Plan_End_Time,PR_Start_Time,PR_End_Time,PR_Loss_Time,PR_Rest_Time,PR_Memo,PR_Time_Diff,PR_Point,PR_Calc_Point"
elseif instr("-MAN-",S_PR_Process) > 0 then
	strSelect			= strSelect		& "PR_Code,PR_Work_Date,PR_Work_Order,PR_Line,PR_Worker_CNT,PR_Supporter_CNT,PR_WorkType,BOM_Sub_BS_D_No,PR_Plan_Amount,PR_Amount,PR_Amount_NG,PR_Plan_Start_Time,PR_Plan_End_Time,PR_Start_Time,PR_End_Time,PR_Loss_Time,PR_Rest_Time,PR_Memo,PR_Time_Diff,PR_ST"
elseif instr("-ASM-DLV-",S_PR_Process) > 0 then
	strSelect			= strSelect		& "PR_Code,PR_Work_Date,PR_Work_Order,PR_Line,PR_Worker_CNT,PR_Supporter_CNT,PR_WorkType,BOM_Sub_BS_D_No,PR_Plan_Amount,PR_Amount,PR_Amount_NG,PR_Plan_Start_Time,PR_Plan_End_Time,PR_Start_Time,PR_End_Time,PR_Loss_Time,PR_Rest_Time,PR_Memo,PR_Time_Diff"
end if
...
strPopup			= ",,,,,,,,,,,,,,,,,,,,,"
strDown				= ",,,,,,,,,,,,,,,,,,,,,"
strAlign			= "Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center"
'----------------------------------------------------------------------------------
...
case "MAN"
	strReg	= ",dt1"&DefaultDate&",txt,"&BasicDataMANLine&"/d"&DefaultLine&",txt5,txt,"&BasicDataMANWorkType&"/d작업,dn2,,txt,txt0,,,txt,txt,txt0,txt0,txt,,,,"
case "ASM"
	strReg	= ",dt1"&DefaultDate&",txt,"&BasicDataASMLine&"/d"&DefaultLine&",txt5,txt,"&BasicDataMANWorkType&"/d작업,dn2,,txt,txt0,,,txt,txt,txt0,txt0,txt,,,"
case "DLV"
	strReg	= ",dt1"&DefaultDate&",txt,"&BasicDataDLVLine&"/d"&DefaultLine&",txt1,txt0,"&BasicDataDLVWorkType&"/d작업,dn2,,txt,txt0,,,txt,txt,txt0,txt0,txt,,,"
end select
