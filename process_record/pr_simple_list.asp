...
if instr("-IMD-SMD-",S_PR_Process) > 0 then
	strSelectName		= strSelectName & "번호,작업날짜,제번,라인,직접원,간접원,작업구분,파트넘버,양품,불량,시작시각,종료시각,LOSS시간,식사/휴식,비고,소요,점수,점수계,삭제"
elseif instr("-MAN-",S_PR_Process) > 0 then
	strSelectName		= strSelectName & "번호,작업날짜,제번,라인,직접원,간접원,작업구분,파트넘버,양품,불량,시작시각,종료시각,LOSS시간,식사/휴식,비고,소요,S/T,삭제"
elseif instr("-ASM-DLV-",S_PR_Process) > 0 then
	strSelectName		= strSelectName & "번호,작업날짜,제번,라인,직접원,간접원,작업구분,파트넘버,양품,불량,시작시각,종료시각,LOSS시간,식사/휴식,비고,소요,삭제"
end if

strWidth			= ""

if instr("-IMD-SMD-",S_PR_Process) > 0 then
	strWidth			= strWidth		& "40,70,80,50,50,50,70,90,40,40,70,70,70,70,250,50,50,50,50"
elseif instr("-MAN-",S_PR_Process) > 0 then
	strWidth			= strWidth		& "40,70,80,50,50,50,70,90,40,40,70,70,70,70,250,50,50,50"
elseif instr("-ASM-DLV-",S_PR_Process) > 0 then
	strWidth			= strWidth		& "40,70,80,50,50,50,70,90,40,40,70,70,70,70,250,50,50"
end if
'----------------------------------------------------------------------------------
...
'2/9
'----------------------------------------------------------------------------------
URL_This			= "/process_record/pr_simple_list.asp"
URL_View			= "/process_record/pr_simple_delete_action.asp"
URL_Action			= "/process_record/pr_simple_list_action.asp"
URL_Reg				= "/process_record/pr_simple_reg_action.asp"

strTable			= "vwPR_List"
strPK				= "PR_Code"
strSelect			= ""
if instr("-IMD-SMD-",S_PR_Process) > 0 then
	strSelect			= strSelect		& "PR_Code,PR_Work_Date,PR_Work_Order,PR_Line,PR_Worker_CNT,PR_Supporter_CNT,PR_WorkType,BOM_Sub_BS_D_No,PR_Amount,PR_Amount_NG,PR_Start_Time,PR_End_Time,PR_Loss_Time,PR_Rest_Time,PR_Memo,PR_Time_Diff,PR_Point,PR_Calc_Point"
elseif instr("-MAN-",S_PR_Process) > 0 then
	strSelect			= strSelect		& "PR_Code,PR_Work_Date,PR_Work_Order,PR_Line,PR_Worker_CNT,PR_Supporter_CNT,PR_WorkType,BOM_Sub_BS_D_No,PR_Amount,PR_Amount_NG,PR_Start_Time,PR_End_Time,PR_Loss_Time,PR_Rest_Time,PR_Memo,PR_Time_Diff,PR_ST"
elseif instr("-ASM-DLV-",S_PR_Process) > 0 then
	strSelect			= strSelect		& "PR_Code,PR_Work_Date,PR_Work_Order,PR_Line,PR_Worker_CNT,PR_Supporter_CNT,PR_WorkType,BOM_Sub_BS_D_No,PR_Amount,PR_Amount_NG,PR_Start_Time,PR_End_Time,PR_Loss_Time,PR_Rest_Time,PR_Memo,PR_Time_Diff"
end if
...
if Request("s_edit_mode_yn") = "" then
	...
	select case S_PR_Process
	case "IMD"
		strEdit	= ",dt1,txt,"&BasicDataIMDLine&",txt,txt,"&BasicDataFAWorkType&",dn1,txt,txt,txt,txt,txt0,txt0,txt,,,,,,"
	case "SMD"
		strEdit	= ",dt1,txt,"&BasicDataSMDLine&",txt,txt,"&BasicDataFAWorkType&",dn2,txt,txt,txt,txt,txt0,txt0,txt,,,,,"
	case "MAN"
		strEdit	= ",dt1,txt,"&BasicDataMANLine&",txt,txt,"&BasicDataMANWorkType&",dn2,txt,txt,txt,txt,txt0,txt0,txt,,,,"
	case "ASM"
		strEdit	= ",dt1,txt,"&BasicDataASMLine&",txt,txt,"&BasicDataMANWorkType&",dn2,txt,txt,txt,txt,txt0,txt0,txt,,,"
	case "DLV"
		strEdit	= ",dt1,txt,"&BasicDataDLVLine&",txt,txt,"&BasicDataDLVWorkType&",dn2,txt,txt,txt,txt,txt0,txt0,txt,,,"
	end select
end if
strPopup			= ",,,,,,,/bom/bs_chart.asp,,,,,,,,,,,,,,,"
strDown				= ",,,,,,,,,,,,,,,,,,,,,"
strAlign			= "Center,Center,,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center,Center"
'----------------------------------------------------------------------------------
...
'4/9
'----------------------------------------------------------------------------------
strColumn		= "s_pr_process,s_pr_work_order,s_BOM_Sub_BS_D_No,s_pr_work_date|/|s_pr_line,s_pr_worktype,s_pr_work_date2,s_edit_mode_yn"
strName			= "공정,제번,파트넘버,작업일|/|라인,작업구분,작업기간,수정모드"
select case S_PR_Process
case "IMD"
	strType	= BasicDataProcess&",txt,dn1,dt1"&date()&"|/|"&BasicDataIMDLine&","&BasicDataFAWorkType&",dt2,chk"
case "SMD"
	strType	= BasicDataProcess&",txt,dn2,dt1"&date()&"|/|"&BasicDataSMDLine&","&BasicDataFAWorkType&",dt2,chk"
case "MAN"
	strType	= BasicDataProcess&",txt,dn2,dt1"&date()&"|/|"&BasicDataMANLine&","&BasicDataManWorkType&",dt2,chk"
case "ASM"
	strType	= BasicDataProcess&",txt,dn2,dt1"&date()&"|/|"&BasicDataASMLine&","&BasicDataManWorkType&",dt2,chk"
case "DLV"
	strType	= BasicDataProcess&",txt,dn2,dt1"&date()&"|/|"&BasicDataDLVLine&","&BasicDataDLVWorkType&",dt2,chk"
end select
'----------------------------------------------------------------------------------
...
select case S_PR_Process
case "IMD"
	strReg	= ",dt1"&DefaultDate&",txt,"&BasicDataIMDLine&"/d"&DefaultLine&",txt1,txt0,"&BasicDataFAWorkType&"/d작업,dn1,txt,txt0,txt,txt,txt0,txt0,txt,,,,,"
case "SMD"
	strReg	= ",dt1"&DefaultDate&",txt,"&BasicDataSMDLine&"/d"&DefaultLine&",txt1,txt0,"&BasicDataFAWorkType&"/d작업,dn2,txt,txt0,txt,txt,txt0,txt0,txt,,,,,"
case "MAN"
	strReg	= ",dt1"&DefaultDate&",txt,"&BasicDataMANLine&"/d"&DefaultLine&",txt"
	select case s_pr_line
	case "P1"
		strReg	= strReg & Worker_CNT_MAN_P1
	case "P2"
		strReg	= strReg & Worker_CNT_MAN_P2
	case "P3"
		strReg	= strReg & Worker_CNT_MAN_P3
	case "P4"
		strReg	= strReg & Worker_CNT_MAN_P4
	case "P5"
		strReg	= strReg & Worker_CNT_MAN_P5
	case else
		strReg	= strReg & "15"
	end select
	strReg	= strReg & ",txt,"&BasicDataMANWorkType&"/d작업,dn2,txt,txt0,txt,txt,txt0,txt0,txt,,,,"
case "ASM"
	strReg	= ",dt1"&DefaultDate&",txt,"&BasicDataASMLine&"/d"&DefaultLine&",txt"
	select case s_pr_line
	case "C1"
		strReg	= strReg & Worker_CNT_ASM_C1
	case "C2"
		strReg	= strReg & Worker_CNT_ASM_C2
	case "C3"
		strReg	= strReg & Worker_CNT_ASM_C3
	case "C4"
		strReg	= strReg & Worker_CNT_ASM_C4
	case "C5"
		strReg	= strReg & Worker_CNT_ASM_C5
	case else
		strReg	= strReg & "15"
	end select
	strReg	= strReg & ",txt,"&BasicDataMANWorkType&"/d작업,dn2,txt,txt0,txt,txt,txt0,txt0,txt,,,,"
case "DLV"
	strReg	= ",dt1"&DefaultDate&",txt,"&BasicDataDLVLine&"/d"&DefaultLine&",txt1,txt0,"&BasicDataDLVWorkType&"/d작업,dn2,txt,txt0,txt0820,txt0820,txt0,txt0,txt,,,"
end select
...
'----------------------------------------------------------------------------------
if instr("-IMD-SMD-",S_PR_Process) > 0 then
	SQL = "select sum(convert(bigint,PR_Calc_Point)) as PR_Calc_Point  from "&strTable&" "
...
'----------------------------------------------------------------------------------
%>
	var strError = List_Reg_Validater('PR_Work_Date,PR_Line,PR_Worker_CNT,PR_WorkType,PR_Amount,PR_Amount_NG,PR_Start_Time,PR_End_Time','작업날짜,라인,작업인원,작업구분,양품수,불량수,시작시각,종료시각','txt,txt,num,txt,num,num,fit4,fit4');
<%
'----------------------------------------------------------------------------------
%>
	if(!strError)
...
'----------------------------------------------------------------------------------
%>
	var strError = List_Validater('PR_Work_Date,PR_Line,PR_Worker_CNT,PR_WorkType,PR_Amount,PR_Amount_NG,PR_Start_Time,PR_End_Time','작업날짜,라인,작업인원,작업구분,양품수,불량수,시작시각,종료시각','txt,txt,num,txt,num,num,fit4,fit4');
<%
'----------------------------------------------------------------------------------
%>
	if(!strError)
