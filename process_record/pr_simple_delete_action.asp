...
'삭제하기 전 내용을 조회
SQL = "select top 1 PR_Work_Order,PR_Line,PR_WorkType,BOM_Sub_BS_D_No,PR_Process,PR_Amount,PR_Work_Date from tbProcess_Record where PR_Code = '"&PR_Code&"'"
...
if PR_WorkType = "작업" and PR_Amount > 0 then
	...
	dim arrTemp
	SQL = "select sum(PR_Amount) from tbProcess_Record where PR_Work_Order='"&PR_Work_Order&"' and PR_Process='"&PR_Process&"'"
	RS1.Open SQL,sys_DBCon
